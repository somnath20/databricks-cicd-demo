...
# =====================================================
# CLINICAL RESEARCH PROJECT WIDGETS
# Example: CTMS STUDY_MASTER FILE INGESTION
# =====================================================
...
#     "'source_schema': '', "
#     "'source_table': '', "
#     "'source_path': '/Volumes/clinical/source/ctms_volume/study_master/', "
#     "'target_layer': 'silver', "
...
dbutils.widgets.text(
    ...
    "'active_flag': 'True', "
    "'load_order': '5', "
    "'created_at': '2026-05-16 15:24:18.818564'}"
)
...
bronze_table = f"clinical.{bronze_schema}.{table_name}"
silver_table = f"clinical.{silver_schema}.{table_name}"
...
try:
    ...
    if load_type in ["APPEND", "MERGE"] and watermark_column:
        ...
        if max_value:
            ...
            spark.sql(f"""
                MERGE INTO clinical.metadata.table_watermarks t
