...
sqlserver_host = "testserver175.database.windows.net"
sqlserver_port = "1433"
sqlserver_database = "pfizer_clinical_db"
sqlserver_user = "my_admin"
sqlserver_password = "somnath@175"

# Secret scope name (will be created if not exists)
secret_scope_name = "clinical-scope"
...
# ----------------------------------------
if response.status_code == 200:
    print(f"Secret scope '{scope_name}' updated successfully.")
else:
    print("Failed to update secret scope.")
    print("Status Code:", response.status_code)
    print("Response:", response.text)
